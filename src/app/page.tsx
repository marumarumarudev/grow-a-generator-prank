  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const msgs = [
        ...
        "OMG I just got the raccoon!",
        "Worked for me after watching the video 🐢✨",
        "Can you get more than 1 pet?",
        "Bro this is so legit 😭",
        "I thought it was fake at first 💀",
        "What does the peacock even do?",
        "Axolotl = W",
        "Waited 24hrs... and it showed up 👀",
        "Is this bannable lol?",
        "Got my 3rd pet today 🔥",
        "Can someone confirm this is safe?",
        "Does the rarity affect pet powers?",
        "I got a common... still cool tho",
        "Broooo I got the dragonfly 🐉💚",
        "Followed instructions and it worked",
        "CAPTCHA didn’t work at first 😤",
        "Do u need premium for this?",
        "I feel like I hacked the system lmao",
        "Where does the pet show up again?",
        "This is the best day ever 😭",
        `I got the ${pet} omg it’s sooo cute 😭`,
        "This is better than the last gen site lol",
        "Can confirm: mine showed up after 1 day",
        "Bee gang where u at 🐝",
        "Got the peacock and raccoon today!",
        "Video was annoying but it’s worth it 💯",
        "Fake or not... I love it 😂",
        "Yo I accidentally got 2 mythicals 🤫",
        "Worked on alt too 😳",
        "Lmao my friend still waiting on his bunny",
        "If this gets patched I’ll cry 😭😭",
        "Just use your real user, it needs to match",
        "Mine showed up after like 2 hours???",
        "Pet not in my mailbox yet, do I wait?",
        "CAPTCHA didn’t load on mobile lol",
        "Bro this feels TOO legit",
        "Just got my 3rd pet today LETS GOOOO",
        "Snail gang rise up 🐌🔥",
        "I swear it’s real my sis got the fox too",
        "This + my robux = OP combo 💸",
      ];
      setChatLog((prev) => [
        ...prev.slice(-20),
